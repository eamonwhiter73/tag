...
class SearchTextField : UITextField {
    ...
    required init() {
        ...
        self.attributedPlaceholder = NSAttributedString(string: "search...", attributes: [NSAttributedStringKey.foregroundColor : colorWhiteAlpha])
        self.backgroundColor = UIColor(red: 200.0/255, green: 17.0/255, blue: 57.0/255, alpha: 0.6)
        self.font = UIFont(name: "Menlo-Regular", size: 28)
